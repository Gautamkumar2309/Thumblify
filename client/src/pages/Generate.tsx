...
import AspectRatioSelector from "../components/AspecitRatioSelector";
import StyleSeletor from "../components/StyleSelector";
                        ...
                        12 shadow-xl space-y-6">
                            ...
                            <div className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    <label className="b1ock text-sm font-medium"> Title or 
                                    Topic</label>
                                ...
                                { /* AspecitRatioSelector */ }
                                <AspectRatioSelector value={aspectRatio} onChange={setAspectRatio}/>
                                { /* StyleSelector */ }
                                <StyleSeletor value={style} onChange={setStyle} isOpen=
