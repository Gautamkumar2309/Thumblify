...
export const generateThumbnail = async (req: Request, res: Response) =>{
    try{
        ...
        prompt += `The thumbnail should be ${aspect_ratio}, visually stunnig, and designed to maximize click-through rate. Make it bold, professional, and impossible to ignore.`
...
export const deleteThumbnail = async (req: Request, res: Response) =>{
      try{
          ...
          await  Thumbnnail.findByIdAndDelete({_id: id, userId})

          res.json({message: 'Thumbnail deletd successfully'});
